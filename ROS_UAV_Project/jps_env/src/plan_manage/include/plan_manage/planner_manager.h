...
#include <path_searching/jm_jps.h>//2021.11.11
...
private:
  ...
  unique_ptr<JmJps> jm_jps_;   //2021.11.12
  vector<BsplineOptimizer::Ptr> bspline_optimizers_;
  //unique_ptr<ctrlModu> ctrl_modu_;
  ...
  void optimizeTopoBspline(double start_t, double duration, vector<Eigen::Vector3d> guide_path,
                           int traj_id);
  void optimizeJmBspline(double start_t, double duration, vector<Eigen::Vector3d> path);
