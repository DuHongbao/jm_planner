...
void TopologyPRM::init(ros::NodeHandle& nh) {
  ...
  Jps_Points_ = nh.subscribe("/global_corners/corner_points", 1, &TopologyPRM::JpsPointsCallback, this);
...
void TopologyPRM::JpsPointsCallback(const sensor_msgs::PointCloud2& globalCorners){
...
void TopologyPRM::path_find(vector<Eigen::Vector3d>  jps_path){
